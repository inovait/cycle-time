...
const calculate = (email, token, domain, project) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const issuesDetails = allIssues.map((issue) => {
        ...
        const whoWorkedOnThisIssue = (0, utils_1.getUserThatWorkedOnIssue)(changelog, assignee, issueEndDate);
        let time;
        try {
        ...
        return Object.assign(Object.assign({}, (0, utils_1.extractMainPropertiesFromIssue)(issue)), { issueStartDate,
            issueEndDate,
            time, whoWorkedOnThisName: whoWorkedOnThisIssue === null || whoWorkedOnThisIssue === void 0 ? void 0 : whoWorkedOnThisIssue.displayName, whoWorkedOnThisAccountId: whoWorkedOnThisIssue === null || whoWorkedOnThisIssue === void 0 ? void 0 : whoWorkedOnThisIssue.accountId });
    });
